...
public class Curs  {
	...
	public void AddNota(String nume_student, String prenume_student, int notaStudent) {
		nota.forEach((s, n) -> {
			if(s.nume.compareTo(nume_student) == 0)
			{
				n = notaStudent;
				this.nota.put(s, notaStudent);
			}
